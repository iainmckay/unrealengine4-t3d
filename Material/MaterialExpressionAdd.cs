...
{
    public class MaterialExpressionAdd : MaterialNode
    {
        ...
        public MaterialExpressionAdd(string name, bool collapsed, int editorX, int editorY, ParsedPropertyBag a, ParsedPropertyBag b, float constA, float constB)
    ...
    public class MaterialExpressionAddProcessor : MaterialNodeProcessor
    {
