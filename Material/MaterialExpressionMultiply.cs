...
namespace JollySamurai.UnrealEngine4.T3D.Material
{
    public class MaterialExpressionMultiply : Node
    {
        ...
        public MaterialExpressionMultiply(string name, UnresolvedExpressionReference a, UnresolvedExpressionReference b, int editorX, int editorY) : base(name, editorX, editorY)
        {
            A = a;
            B = b;
        }
